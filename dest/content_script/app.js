...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dislike = __webpack_require__(159);

	var _dislike2 = _interopRequireDefault(_dislike);

	var _comment_list = __webpack_require__(163);
	...
	waitForElement(".yj-message-list-item--action-list.yj-actions", 5000).then(function (element) {
	  console.log('<<< wait!');
	  var actions = $(element);
	  var container = $('<li class="yj-message-list-item--action-list-item yj-message-action-list-item yj-dislike-list-item">');
	  ...
	  console.log('<<< dislike');
	  _reactDom2.default.render(_react2.default.createElement(_dislike2.default, null), container[0]);
	  var sidebar = $('.yj-selector-right-sidebar');
	  var temp = $('<div role="complementary" id="commentSidebar" class="yj-thread-sidebar">');
	  sidebar.append(temp);
	  if (sidebar.length == 0) {
	    var sidebarArea = $('<div class="yj-selector-right-sidebar yk-col-sm-5 yk-col-md-6 yk-col-lg-6">');
	  }
	  var sideContainer = $('<div class="yj-conversation--actions"><h2 class="yj-conversation--actions-header" role="presentation"><span role="heading" aria-level="2">Conversation Actions</span></h2>');
	  var threadSidebar = $('.yj-thread-sidebar');
	  ...
	  _reactDom2.default.render(_react2.default.createElement(_comment_list2.default, { comments: json }), temp[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dislike = (function (_React$Component) {
	  _inherits(Dislike, _React$Component);

	  function Dislike() {
	    _classCallCheck(this, Dislike);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Dislike).apply(this, arguments));
	  }

	  _createClass(Dislike, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "a",
	        { onClick: this.onClick, role: "button", href: "javascript://", title: "like this message", className: "yj-message-list-item--action-list-link" },
	        _react2.default.createElement("span", { className: "yj-message-list-item--action-list-icon yamicon yamicon-regular yamicon-rd_like" }),
	        _react2.default.createElement(
	          "span",
	          { className: "yj-message-list-item--action-list-label", "aria-hidden": "true" },
	          this.label()
	        ),
	        _react2.default.createElement(
	          "span",
	          { className: "yj-message-list-item--action-list-acc yj-acc-hidden" },
	    ...
	    value: function onClick(evt) {
	      if (!this.props.disliked) {
	        ...
	        new Promise(function (resolve, reject) {
	          _superagent2.default.get('https://api.twitter.com/1.1/search/tweets.json?q=twitterapi').end(function (res) {
	            if (res.status === 404) {
	              reject();
	            } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comment_item = __webpack_require__(164);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.comments.map(function (comment, i) {
	          ...
	          console.log(comment);
	          return _react2.default.createElement(_comment_item2.default, { comment: comment, key: i });
	        })
	      );
	    }
	  }]);
